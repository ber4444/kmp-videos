...
import 'flutter_twitter_login.dart';
import 'package:http/http.dart' as http;
import 'package:random_string/random_string.dart';
import 'twitter/user.dart';
...
class TwitterClient {
  ...
  static String _consumerKey = "cXoizHGR1P6H0Nx7Sbtj95LrM";
  static String _secretKey = "XaXEXnMwSDlWNfSfFgSE3RgfIRnBXNaFJQN6pFAqOjIfC5DFN2";
  ...
  static Future<int> _startSession() async {
    var twitterLogin =
        new TwitterLogin(consumerKey: _consumerKey, consumerSecret: _secretKey);
  ...
  Future<String> getName() async {
    ...
    if (_profile != null) return _profile.name;
  ...
  Future<http.Response> _twitterGet(
    ...
    //print('Oauth $oauthConsumer, $oauthNonce, $oauthSig, $oauthMethod, $oauthTime, $oauthToken, $oauthVersion');
    //print(new Uri.https("api.twitter.com", base, paramMap));
    return await http
  ...
  Future<bool> getMembership(String screenName) async {
    String base = '/1.1/friendships/lookup.json';
    final params = [
    ...
    if (response.statusCode == 200) {
      final connections = json.decode(response.body);
      print(connections[0]);
      print(connections[0]["connections"]);
      final String connection = connections[0]["connections"][0];
