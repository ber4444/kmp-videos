pluginManagement {
    ...
    plugins {
        ...
        id("org.jetbrains.kotlin.android") version "2.4.20-RC3"
        id("org.jetbrains.kotlin.multiplatform") version "2.4.20-RC3"
        id("org.jetbrains.kotlin.plugin.compose") version "2.4.20-RC3"
